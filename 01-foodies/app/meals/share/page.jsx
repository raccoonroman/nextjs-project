...
import FormSubmit from '@/app/components/meals/form-submit';
import classes from './page.module.css';

export default function ShareMealPage() {
  const [state, formActon] = useFormState(shareMeal, {
    message: null,
  });
  return (
    <>
      ...
      <main className={classes.main}>
        <form className={classes.form} action={formActon}>
          ...
          <p className={classes.actions}>
            <FormSubmit>Share meal</FormSubmit>
          </p>
        </form>
      </main>
    </>
